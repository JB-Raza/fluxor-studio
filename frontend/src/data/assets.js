...
export const aboutMedia = {
  portrait: '/media/images/about-portrait.png',
  portraitAlt: 'Fluxor studio creative lead',
}
...
export const workPosters = {
  cgi: '/media/posters/work-cgi.jpg',
  brand: '/media/posters/work-brand.jpg',
  product: '/media/posters/work-product.jpg',
  caseStudy: '/media/posters/work-case.jpg',
  motion: '/media/posters/work-motion.jpg',
}

export const workVideos = {
  cgi: '/media/videos/work-cgi.mp4',
  brand: '/media/videos/work-brand.mp4',
  product: '/media/videos/work-product.mp4',
